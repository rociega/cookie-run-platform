...
import { Search, Server, Activity, AlertCircle, RefreshCw, ChevronRight, Terminal, CreditCard, Shield, Cpu, ExternalLink, ArrowRightLeft } from "lucide-react";
        ...
        <div className="min-h-full text-foreground font-sans pb-16">
            <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 py-7 flex flex-col xl:flex-row gap-6">
                ...
                <div className="flex-1 min-w-0 space-y-6">
                    ...
                    <section data-testid="section-hero" className="pb-4 flex flex-col justify-between items-start gap-4 border-b border-border">
                        ...
                        <div className="flex flex-wrap items-center gap-3 shrink-0 mt-2">
                            ...
                            <a
                                data-testid="link-hero-bridge"
                                href="https://hyperlane.cookiescan.io/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-[13px] font-mono uppercase font-semibold text-foreground px-4 py-2.5 border border-border hover:bg-secondary transition-colors inline-flex items-center gap-2"
                            >
                                Bridge COOK <ExternalLink size={14} />
                            </a>
                ...
                <div className="w-full xl:w-[320px] flex flex-col gap-6 shrink-0">
                    ...
                    {/* Official bridge handoff — the bridge blocks iframe embedding. */}
                    <div className="bg-background border border-border p-5">
                        <div className="flex items-center gap-2 mb-3">
                            <ArrowRightLeft className="text-foreground" size={18} />
                            <h3 className="text-[12px] font-mono font-bold text-foreground uppercase tracking-widest">Bridge COOK</h3>
                        </div>
                        <p className="text-[13px] text-muted-foreground leading-relaxed mb-4">
                            Move COOK between Solana and Cookie Chain with the official Cookie Bridge. Transfers are 1:1 with no bridge fee; network fees and delivery time still apply.
                        </p>
                        <div className="border-y border-border py-3 mb-4 text-[11px] font-mono uppercase tracking-wider text-muted-foreground space-y-2">
                            <div className="flex items-center justify-between"><span>Route</span><span className="text-foreground">Solana ↔ Cookie</span></div>
                            <div className="flex items-center justify-between"><span>Delivery</span><span className="text-foreground">~1 minute</span></div>
                        </div>
                        <a
                            data-testid="link-cookie-bridge"
                            href="https://hyperlane.cookiescan.io/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-full inline-flex items-center justify-center gap-2 bg-foreground text-background border border-foreground hover:bg-background hover:text-foreground px-4 py-2.5 text-[11px] font-mono uppercase font-bold tracking-wider transition-colors"
                        >
                            Open Cookie Bridge <ExternalLink size={14} />
                        </a>
                        <p className="mt-3 text-[11px] text-muted-foreground leading-relaxed">
                            Opens the official Hyperlane-powered bridge in a new tab so your wallet stays connected to the correct network.
                        </p>
                    </div>
